...
$(function(){
    ...
    $( "body" ).on("click", ".editView", function(){
        ...
        var url = "completedtrip-details/"+ id ;
        serverCall(url, null, 'get', true, null, null, null, function (res) {
           ...
           // return false;
            if (res.length>0) {
                console.log(res[0].data.vehicles_type.vehicle_type_name);
                alert("status = "+res[0].status+"vehicle = "+res[0].data.vehicles_type.vehicle_type_name);
                if(res[0].status == true){
                    $( "input[name=order_uid]" ).val(res[0].data.order_uid).trigger("change");
                    ...
                    $( "input[name=vehicles_type_name]" ).val(res[0].data.vehicles_type.vehicle_type_name).trigger("change");
                    $( "input[name=location]" ).val(res[0].data.location).trigger("change");
