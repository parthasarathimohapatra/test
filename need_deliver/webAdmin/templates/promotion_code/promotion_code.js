...
$(function(){
    ...
    $( "body" ).on("click", ".action-btn", function(){
        ...
        var url = "updatePromotionCodeRecords";
	...
	$( "body" ).on("click", ".btn-add-new", function(){
        ...
        $( "input[name=promotion_code]" ).val(randomstr).trigger("change");
    ...
    $( "body" ).on("click", ".editView", function(){
        ...
        var url = "promotioncode-details/"+ id ;
        serverCall(url, null, 'get', true, null, null, null, function (res) {
           ...
           // return false;
            if (res.length>0) {
                if(res[0].status == true){
                    $( "input[name=promotion_code]" ).val(res[0].data.promotion_code).trigger("change");
                    $( "input[name=discount]" ).val(res[0].data.discount).trigger("change");
                    $( "input[name=start_date]" ).val(res[0].data.start_date).trigger("change");
                    $( "input[name=end_date]" ).val(res[0].data.end_date).trigger("change");
...
function randomString() {
    ...
    var promo_code = "ND"+randomstring;
