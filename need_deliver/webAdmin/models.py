...
def get_file_path(instance, filename):
    ...
    return os.path.join('parcel_files', filename)
def get_file_path_user_obj(instance, filename):
    ext = filename.split('.')[-1]
    filename = "%s.%s" % (uuid.uuid4(), ext)
    return os.path.join('users_attachments', filename)
# Create your models here. 
class NdImage(models.Model):
	
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False,verbose_name='ID')
	title = models.CharField(max_length=50, null=True)
	image_file = models.ImageField(upload_to='uploaded_images', null=True, blank=True)
	applied_to = models.CharField(max_length=50, null=True)
...
class NdCurrencies(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False,verbose_name='ID')
	currency_name = models.TextField(null=True)
	currency = models.CharField(max_length=10, null=True)
	default_currency = models.BooleanField(default=False)
	conversion_rate = models.DecimalField(max_digits=25, decimal_places=6, default=Decimal('0.000000'))
	is_status = models.BooleanField(default=True)
	is_deleted = models.BooleanField(default=False)
	language_type = models.TextField(null=True, blank=True, max_length=50)
	date_updated = models.DateTimeField(auto_now=True, null=True, blank=True)
	class Meta:
		db_table ='nd_currencies'

class NdSubscriptionPlan(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	plan_name = models.CharField(max_length=100, null=True)
	price = models.DecimalField(max_digits=20, decimal_places=2, null=True, default=0.00)
	currency = models.CharField(max_length=10, null=True)
	ndcurrency = models.ForeignKey(NdCurrencies, on_delete=models.CASCADE, null=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	
	class Meta:
		db_table = 'nd_subscription_plan'
		

class NdSplashScreen(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False,verbose_name='ID')
	heading = models.CharField(max_length=150, null=True)
	image_file = models.ImageField(upload_to='uploaded_images/splash_screen', null=True, blank=True)
	splash_text = models.TextField(null=True)
	is_status = models.BooleanField(default=True)
	is_deleted = models.BooleanField(default=False)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table ='nd_splash_screen' 

class NdRoles(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False,verbose_name='ID')
	role_title = models.TextField(null=True)
	is_status = models.BooleanField(default=True)
	is_deleted = models.BooleanField(default=False)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	date_updated = models.DateTimeField(auto_now=True, null=True, blank=True)
...
class NdCountries(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False,verbose_name='ID')
	country_code = models.TextField(null=True, blank=True)
	country_name = models.TextField(null=True, blank=True)
	country_isd_code = models.TextField(null=True)
	class Meta:
		db_table ='nd_countries'

class NdStates(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False,verbose_name='ID')
	state_name = models.TextField(null=True, blank=True)
	country = models.ForeignKey(NdCountries, on_delete=models.CASCADE, null=True)
	
	class Meta:
		db_table ='nd_states'

class NdUsers(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	...
	temp_phone_number = models.CharField(max_length=50, null=True, blank=True)
	role = models.ForeignKey(NdRoles, on_delete=models.CASCADE, null=True)
	verification_code = models.TextField( blank=True, null=True, max_length=15)
	device_token = models.TextField(null=True, blank=True)
	country = models.ForeignKey(NdCountries, on_delete=models.CASCADE, null=True)
	state = models.ForeignKey(NdStates, on_delete=models.CASCADE, null=True)
	city = models.CharField(max_length=50, null=True)
	zipcode = models.CharField(max_length=50, null=True)
	description = models.TextField(null=True)
	dob = models.DateField(null=True)
	random_key = models.TextField( blank=True, null=True)
	reg_date = models.DateField(auto_now_add=True, null=True, blank=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_phone_no_verified = models.BooleanField(default=False, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	device_uuid = models.UUIDField(unique = True, default=uuid.uuid4, editable=False)
	profile_picture = models.ImageField(upload_to='uploaded_images/profile_pic', blank=True)
	current_location = models.TextField( blank=True, null=True)
	latitude = models.DecimalField(max_digits=35, decimal_places=6,default=Decimal('0.000000'))
	longitude = models.DecimalField(max_digits=35, decimal_places=6,default=Decimal('0.000000'))
	gender = models.CharField(max_length=50, null=True)
	# location_point =  models.PointField(blank = True, null=True, srid=4326)
	socket_id = models.TextField(null=True, max_length=100)
...
class NdLanguages(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False,verbose_name='ID')
	lang_name = models.TextField(null=True)
	image_file = models.ImageField(upload_to='uploaded_images/lang_logo', null=True, blank=True)
	
	is_status = models.BooleanField(default=True)
	is_deleted = models.BooleanField(default=False)
	date_updated = models.DateTimeField(auto_now=True, null=True, blank=True)
	class Meta:
		db_table ='nd_languages'
 



class NdVehicleType(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	vehicle_type_name = models.CharField(max_length=100, null=True)
	vehicle_type_name_com = models.CharField(max_length=100, null=True, blank=True)
	#KM per hour rate
	base_fare = models.DecimalField(max_digits=20, decimal_places=2, null=True, default=0.00)
	khr = models.DecimalField(max_digits=20, decimal_places=2, null=True, default=0.00)
	max_distance = models.DecimalField(max_digits=20, decimal_places=2, null=True, default=0.00)
	vehicle_logo = models.ImageField(upload_to='vehicles/type', null=True, blank=True)
	top_view_logo = models.ImageField(upload_to='vehicles/type', null=True, blank=True)
	person_capcity = models.IntegerField(null=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_vehicle_type'

class NdPaymentMethod(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	name = models.CharField(max_length=100, null=True)
	payment_logo = models.ImageField(upload_to='uploaded_images/payment_logo', null=True, blank=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_payment_method'

class NdPromotions(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	promotion_code = models.CharField(max_length=10, null=True)
	
	discount = models.DecimalField(max_digits=20, decimal_places=2, null=True, default=0.00)
	...
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_promotions'

class NdCancellationReason(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	...
	class Meta:
		db_table = 'nd_cancellation_reason'

class NdOrder(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	driver = models.ForeignKey(NdUsers, on_delete=models.CASCADE, related_name='driver_id', null=True)
	supplier = models.ForeignKey(NdUsers, on_delete=models.CASCADE, related_name='supplier_id', null=True)
	vehicles_type = models.ForeignKey(NdVehicleType, on_delete=models.CASCADE, related_name='vehicle_type_details', null=True)
	currency = models.ForeignKey(NdCurrencies, on_delete=models.CASCADE, related_name='currency_details', null=True)
	conversion_rate = models.DecimalField(decimal_places=6, max_digits=35, default=0.000000)
	contact_name = models.CharField(max_length=200, null=True, blank=True)
	contact_number = models.CharField(max_length=50, null=True, blank=True)
	note_to_driver = models.CharField(max_length=100, null=True, blank=True)
	location = models.TextField(null=True, blank=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	booking_status = models.IntegerField(default=1, blank=True)
	distance = models.DecimalField(decimal_places=2, max_digits=35, default=0.00)
	base_price = models.DecimalField(decimal_places=2, max_digits=35, default=0.00) 
	latitude = models.TextField(null=True, max_length=100)
	longitude = models.TextField(null=True, max_length=100)
	order_uid = models.TextField(null=True, max_length=70, blank=True)
	base_fare_payment_method_first = models.IntegerField(null=True, default=0, blank=True)
	base_fare_payment_method_second = models.IntegerField(null=True, default=0, blank=True)
	cash_collection_method_first = models.IntegerField(null=True, default=0, blank=True)
	cash_collection_method_second = models.IntegerField(null=True, default=0, blank=True)	
	cash_collection_first_currency = models.TextField(null=True, max_length=25, blank=True)
	cash_collection_second_currency = models.TextField(null=True, max_length=25, blank=True)
	cost_discount_applied = models.DecimalField(decimal_places=2, max_digits=12, default=0.00, blank=True) 
	cash_on_hand_discount = models.DecimalField(decimal_places=2, max_digits=12, default=0.00, blank=True) 
	coupon = models.ForeignKey(NdPromotions, on_delete=models.CASCADE, null=True, blank=True, related_name='couponOrderDetails')
	# cash_collection_method = models.IntegerField(null=True, default=0, blank=True) 
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	date_updated = models.DateTimeField(auto_now=True, null=True, blank=True)
	booking_time = models.DateTimeField(null=True, blank=True)
	delivery_time = models.DateTimeField(null=True, blank=True)
	total_time_taken = models.BigIntegerField(null=True, default=0)
	class Meta:
		db_table = 'nd_order'

class NdBookingRejects(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	driver = models.ForeignKey(NdUsers, on_delete=models.CASCADE, related_name='driverDetails', null=True)
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='orderDetails')
	cancel_time = models.DateTimeField(auto_now=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_booking_rejects'
		
class NdDropOffLocation(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='drop_ord_details')
	location = models.TextField(max_length=200, null=True, blank=True)
	item_name = models.TextField(max_length=200, null=True, blank=True)
	contact_name = models.CharField(max_length=200, null=True, blank=True)
	contact_number = models.CharField(max_length=50, null=True, blank=True)
	note_to_driver = models.CharField(max_length=100, null=True, blank=True)
	...
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	drop_location_type = models.IntegerField(null=True)
	cash_collection = models.DecimalField(decimal_places=2, max_digits=12, default=0.00, blank=True) 
	distance = models.DecimalField(decimal_places=2, max_digits=15, default=0.00)
	class Meta:
		db_table = 'nd_drop_off_location'

class NdParcelInformations(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='order')
	location = models.ForeignKey(NdDropOffLocation, on_delete=models.CASCADE, null=True, related_name='location_id')
	parcel_file = models.FileField(upload_to=get_file_path, null=True, blank=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	class Meta:
		db_table = 'nd_parcel_informations'

class NdOrderCompletionDetails(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='order_comp_details')
	latitude = models.TextField(null=True, max_length=100)
	longitude = models.TextField(null=True, max_length=100)
	actual_distance = models.DecimalField(decimal_places=2, max_digits=12, default=0.00)
	# arrival_status = models.BooleanField(default=True, blank=True)
	arrival_time = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	location_type = models.IntegerField(null=True, blank=True)
	class Meta:
		db_table = 'nd_order_completion_details'

class NdSavedLocations(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	user = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='user_details')
	location_name = models.TextField(max_length=200, null=True)
	location = models.TextField(null=True, blank=True)
	location_type = models.IntegerField(default=0, null=True, blank=True)
	latitude = models.TextField(max_length=100, null=True)
	longitude = models.TextField(max_length=100, null=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	date_updated = models.DateTimeField(auto_now=True, null=True, blank=True) 
	class Meta:
		db_table = 'nd_saved_locations'
		
class NdCancelOrder(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	cancelled_by = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='cancelled_by_details')
	supplier = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='supplier_details')
	driver = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='driver_details')
	reason = models.ForeignKey(NdCancellationReason, on_delete=models.CASCADE, null=True, related_name='reason_details')
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='order_details')
	reason_description = models.TextField(null=True, max_length=200, blank=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_cancel_order'

class NdNotifications(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	user = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='receiver_details')
	title = models.TextField(null=True, max_length=200, blank=True)
	...
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_notifications'

class NdUsersObjects(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	user = models.OneToOneField(NdUsers, on_delete=models.CASCADE, null=True, related_name='users_object_details')
	over_all_rating = models.DecimalField(max_digits=10, decimal_places=2,default=Decimal('0.00'))
	no_of_reviews = models.IntegerField(default=0, null=True)
	last_review_posted_on = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	is_available = models.BooleanField(default=True, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_users_objects'
		
class NdReviewTypes(models.Model):
	id = models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	review_reason = models.TextField(null=True, max_length=150)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	class Meta:
		db_table = 'nd_review_types'

class NdReviewPosted(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	posted_by = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='posted_by')
	driver = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='driverdetails')
	review_type = models.ForeignKey(NdReviewTypes, on_delete=models.CASCADE, null=True, related_name='review_type_details')
	review_text = models.TextField(null=True, max_length=250)
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='orderdetails')
	star_rate = models.DecimalField(max_digits=10, decimal_places=2,default=Decimal('0.00'))
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_review_posted'

class NdBookingRequests(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='book_order')
	driver = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='selected_driver')
	estimate_time = models.IntegerField(default=0, null=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	...
	longitude = models.TextField(max_length=100, null=True)
	class Meta:
		db_table = 'nd_booking_req'
		
class NdSettings(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	field_name = models.TextField(null=True, max_length=200, blank=True)
	alias_name = models.TextField(null=True, max_length=200, blank=True)
	field_val = models.TextField(null=True, max_length=250, blank=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_settings'

class NdAppliedCoupons(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	coupon = models.ForeignKey(NdPromotions, on_delete=models.CASCADE, null=True, related_name='couponDetails')
	# order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='orderDetailsCoupon')
	supplier = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='supplierDetailsCoupon')
	# is_expired = models.BooleanField(default=False, blank=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_applied_coupons'

class NdCurrentDriverLocation(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	order = models.ForeignKey(NdOrder, on_delete=models.CASCADE, null=True, related_name='order_current_loc')
	driver = models.ForeignKey(NdUsers, on_delete=models.CASCADE, null=True, related_name='driver_current_loc')
	latitude = models.TextField(max_length=100, null=True)
	longitude = models.TextField(max_length=100, null=True)
	real_distance = models.DecimalField(decimal_places=2, max_digits=12, default=0.00)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_current_driver_location'

class NdAdminPushNotifications(models.Model):
	id = models.AutoField(
		auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
	message_title = models.CharField(max_length=100, null=True)
	message_body = models.CharField(max_length=250, null=True)
	role = models.ForeignKey(NdRoles, on_delete=models.CASCADE, null=True)
	is_status = models.BooleanField(default=True, blank=True)
	is_deleted = models.BooleanField(default=False, blank=True)
	date_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	class Meta:
		db_table = 'nd_admin_push_notifications'

class InsertDefaultData():
	def InsertCountries():
		is_exists = NdCountries.objects.filter().count()
		if is_exists == 0:
			cur = connection.cursor()
			cur.execute("INSERT INTO nd_countries (id, country_code, country_name, country_isd_code) VALUES\
				(1, 'AF', 'Afghanistan', 93),\
				(2, 'AL', 'Albania', 355),\
				(3, 'DZ', 'Algeria', 213),\
			...
			")
	def InsertStates():
		is_exists = NdStates.objects.filter().count()
		if is_exists == 0:
			cur = connection.cursor()
			cur.execute("INSERT INTO nd_states (id, state_name, country_id) VALUES\
...
InsertDefaultData.InsertCountries()
InsertDefaultData.InsertStates()
