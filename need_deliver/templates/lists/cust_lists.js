    ...
    var dataTable = $('#tblCustomer').DataTable( {
        ...
        "ajax":{
        	beforeSend : function(data){
        		$("#tblCustomer").append('<tbody class="preloader-loader-content"><tr><th class="preload-datatable" colspan="10"><img class="datatable-loader" src="{{ settings.BASE_URL }}/static/images/dataloader.gif"></th></tr></tbody>');
        	},
